...
#
VOLUME="$HOME/khulnasoft-docker/worker-disk"
...
docker run --detach \
    ...
    -v $VOLUME:/mnt/cache \
    index.docker.io/khulnasoft/worker:187572_2022-12-06_cbecc5321c7d@sha256:0092211fee815b82d426ccf0a30999f8fb40749811e3a83c7570e576f028da74
