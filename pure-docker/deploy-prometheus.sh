...
#
VOLUME="$HOME/khulnasoft-docker/prometheus-v2-disk"
...
docker run --detach \
    ...
    index.docker.io/khulnasoft/prometheus:187572_2022-12-06_cbecc5321c7d@sha256:2113ccab80409e995ee7ed9a3d386051f4ca73186375a3a0d7e3d55c90fa2007
