...
# Network: 100mbps
# Liveness probe: HTTP GET http://khulnasoft-frontend:3080/healthz
# Ports exposed to other Khulnasoft services: 6060/TCP
# Ports exposed to the public internet: 3080 (HTTP) and/or 3443 (HTTPS)
#
VOLUME="$HOME/khulnasoft-docker/khulnasoft-frontend-$1-disk"
./ensure-volume.sh $VOLUME 100
docker run --detach \
    --name=khulnasoft-frontend-$1 \
    --network=khulnasoft \
    --restart=always \
    --cpus=4 \
    --memory=8g \
    ...
    index.docker.io/khulnasoft/frontend:187572_2022-12-06_cbecc5321c7d@sha256:73e64a8636e70ebbaf7f4a3300479529294f67e8cf644cdaea02435915aec869
...
echo "Deployed khulnasoft-frontend $1 service"
