...
# https://docs.khulnasoft.com/admin/updates/pure_docker similar to https://docs.khulnasoft.com/admin/updates/pure_docker#v3-12-5-v3-13-2-changes
echo
echo "forcing static permissions on volume directories"
echo
pushd ~/khulnasoft-docker
chown -R 100:101 gitserver* prometheus-v2* worker* repo-updater* searcher* khulnasoft-frontend* symbols* zoekt* blobstore-disk
